...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState !=null){
            boolean isVisible = savedInstanceState.getBoolean("State_key");
            if (isVisible){
                nDisplayHeader.setVisibility(View.VISIBLE);
                nReplyDisplay.setText(savedInstanceState.getString("Key_text"));
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        if(nDisplayHeader.getVisibility()==View.VISIBLE){
            outState.putBoolean("State_key",true);
            outState.putString("Key_text",nReplyDisplay.getText().toString());
        }
    }
